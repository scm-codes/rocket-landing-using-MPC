...
plot(ref_traj(:,7),ref_traj(:,4)*r2d,'k--','LineWidth',2,'DisplayName','Reference')
xlim([0 16])
hold off
set(gca,'FontSize',20)
set(gca,'TickLabelInterpreter','latex');
...
plot(ref_traj(:,7),ref_traj(:,5)*r2d,'k--','LineWidth',2,'DisplayName','Reference')
hold off
xlim([0 16])
set(gca,'FontSize',20)
set(gca,'TickLabelInterpreter','latex');
...
plot(ref_traj(:,7),ref_traj(:,6)*r2d,'k--','LineWidth',2,'DisplayName','Reference')
hold off
xlim([0 16])
set(gca,'FontSize',20)
set(gca,'TickLabelInterpreter','latex');
...
sgtitle(fig_labels{1},'fontsize',30,'interpreter','latex');
saveas(fig,fig_labels{2},'epsc')
...
title(fig_labels{3},'fontsize',30,'interpreter','latex')
grid on
axis equal
saveas(trajfig,fig_labels{4},'epsc')